////bendrinio pobudzio darbines funkcijos, kuriu mums gali prireikti. Pagalbines funkcijos, kurioms nesvarbus kontekstas, kur jos dirba, svarbu dirba.
...
utils.hash = (str) => {
    if (typeof str === 'string' && str !== '') {     ///tipas yra stringas ir nera tuscias stringas, tada galima toliau dirbti. Nes kriptografija dirba tik su stringais. Sifravimas.
