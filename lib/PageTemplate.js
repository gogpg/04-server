    ...
    class PageTemplate {
        ...
        footerHTML() {
            ...
            return `<footer class="container">
                        <div class="row main-footer">
                            &copy; ${formatedDate}&nbsp;-&nbsp;<a href="https://github.com/front-end-by-rimantas" target="_blank">R</a>
                        </div>
                    </footer>`;
        }
        ...
        scriptHTML() {
            ...
            HTML += isLoggedIn
                ? scriptTag(`components/commonPrivate`)
                : scriptTag(`components/commonPublic`);
    
            if (this.pageJSfileName !== '') {
                HTML += scriptTag(`pages/${this.pageJSfileName}`);
            }
